...
* adb
* a fully static standalone Linux adbd with TCP, VSOCK, optional USB
  FunctionFS transports, and Rockchip RKNN Toolkit2 transfer compatibility
  (see [LINUX_ADBD.md](LINUX_ADBD.md))
* fastboot
